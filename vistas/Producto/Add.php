...
<body style="background-color:beige">
  <h2 style=" display: flex; align-content: center; margin-left: 38%; margin-top: 5%;"> Registro Producto </h2>
  <br>
  <form action="metodoAdd.php" method="POST" style="width: 50%; margin-left: 25%;">
    <div class="row">
      ...
      <div class="col">
        Codigo Producto:
        <input type="text" class="form-control" placeholder="" name="codigo_producto">
      </div>
      <div class="col">
        Descripción:
